...
<template>
  <form @submit.prevent="handleSubmit" class="duplicate-form">
    <div class="form-group">
      <p class="form-description">¿Deseas conservar los valores del grupo actual al duplicarlo?</p>
      ...
      <div class="radio-group">
        <label class="radio-option">
          ...
          <span class="radio-label">
            ...
            <span class="radio-description"
              >El grupo duplicado mantendrá todos los valores actuales</span
            >
          </span>
        </label>
        ...
        <label class="radio-option">
          ...
          <span class="radio-label">
            ...
            <span class="radio-description">El grupo duplicado se creará sin valores</span>
          </span>
        </label>
      </div>
    </div>
    ...
    <div class="form-actions">
      ...
      <button type="submit" class="btn btn-submit" :disabled="isSubmitting">
        {{ isSubmitting ? 'Duplicando...' : 'Duplicar Grupo' }}
      </button>
    </div>
  </form>
</template>
